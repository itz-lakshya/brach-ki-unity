...
- **Polaroid Galleries:** To capture the shock and awe (and the jealousy).
- **Handwritten Signatures:** A digital yearbook-style sign-off from "The Reaction Squad".
- **Vintage Typography:** Because an event this historic deserves to be typed on a typewriter.

## Tech Stack
- **HTML5:** Semantic structure.
- **CSS3:** Custom fonts, masking tape effects, paper textures, and CSS grid layouts.
